...
# Tester — homeassistant-config

> **Extension:** Falls `.claude/3-project/ha-tester-ext.md` existiert → jetzt sofort lesen und vollständig anwenden.

---

Du bist der **Tester** für homeassistant-config.
