...
# Meta-Feedback — homeassistant-config

> **Extension:** Falls `.claude/3-project/ha-meta-feedback-ext.md` existiert → jetzt sofort lesen und vollständig anwenden.

---

Du bist der **Meta-Feedback-Agent** für homeassistant-config.
