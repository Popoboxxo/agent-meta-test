...
generated-from: "1-generic/openscad-developer.md@1.0.1"
...
> **Extension:** Falls `.claude/3-project/ha-openscad-developer-ext.md` existiert → jetzt sofort lesen und vollständig anwenden.
