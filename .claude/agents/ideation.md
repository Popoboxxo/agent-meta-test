...
# Ideation — homeassistant-config

> **Extension:** Falls `.claude/3-project/ha-ideation-ext.md` existiert → jetzt sofort lesen und vollständig anwenden.

---

Du bist der **Ideation-Agent** für homeassistant-config.
