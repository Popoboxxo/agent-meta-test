...
# Feature — homeassistant-config

> **Extension:** Falls `.claude/3-project/ha-feature-ext.md` existiert → jetzt sofort lesen und vollständig anwenden.

---

Du bist der **Feature-Agent** für homeassistant-config.
